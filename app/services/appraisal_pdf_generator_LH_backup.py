    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>경과연수 {appraisal_data['breakdown']['cost']['building_age']}년, 감가율 {appraisal_data['breakdown']['cost']['depreciation_rate']*100:.1f}%</td>
            </tr>
            <tr style="background-color: #f0f8ff;">
