...
<b>① 직주 근접을 중시</b>하고,<br/>
<b>② 단기 거주 이동성이 높으며</b>,<br/>
<b>③ 대형 커뮤니티보다는 개인 생활 중심의 주거를 선호</b>하는<br/>
<u>도심형 1~2인 생활 패턴</u>을 의미합니다.<br/>
<br/>
...
<br/>
<b>■ 이 범위 선정의 논리적 근거</b><br/>
<br/>
이 범위({int(legal_units * 0.8)}~{int(legal_units * 0.9)}세대)는<br/>
<b>① M3 청년형 수요의 적정 규모</b> (과잉 공급 방지),<br/>
<b>② 주차·일조 리스크 최소화</b> (Hard Fail 회피),<br/>
<b>③ M5 수익성의 변동성 감소</b> (안정적 수익 구조),<br/>
<b>④ M6 심사 시 Hard Fail 회피 가능성</b> (조건부 통과)<br/>
을 <u>동시에 만족시키는 균형점</u>입니다.<br/>
<br/>
법적 최대 규모는 가능하나,<br/>
