"""
ZeroSite Type Demand Score v3.0
================================================================================
LH 규정 기반 유형별 수요점수 계산 엔진

주요 기능:
1. LH 공식 규정 기반 점수 계산 (유형 간 최소 10~20점 차이 보장)
2. Kakao POI 거리 가중치 유형별 차등 적용
...
class TypeDemandScoreV3:
    ...
    def __init__(self):
        """초기화"""
        logger.info("🎯 Type Demand Score v3.0 초기화")
...
def get_type_demand_score_v3() -> TypeDemandScoreV3:
    """Type Demand Score v3.0 인스턴스 반환 (싱글톤)"""
